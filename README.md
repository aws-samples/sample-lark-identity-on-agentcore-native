...
| `docs/agentcore-behavior.md` | measured AgentCore Gateway/Runtime behavior, incl. why the Gateway can't supply a per-user token for a CustomOauth2 provider |
